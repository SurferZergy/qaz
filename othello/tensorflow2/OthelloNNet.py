...
class OthelloNNet():
    def __init__(self, game, args):
        ...
        h_conv4 = Activation('relu')(BatchNormalization(axis=3)(Conv2D(args.num_channels, 3, padding='valid', use_bias=False)(h_conv2)))        # batch_size  x (board_x-4) x (board_y-4) x num_channels
