...
#   # def __init__(self, state_size, action_size, qnn_layers, qnn_type, action_lim, last_w_scale=1e-3, QPU_device='default.qubit', torch_device='gpu', rsample=False):
...
#         # super().__init__()
#         self.rsample = True
#         self.actor_net = HybridModel(input_dim=self.board_x*self.board_y, output_dim=2*action_size, qnn_layers=4, qnn_type='ReUploadingVQC', last_w_scale=1e-3, QPU_device='default.qubit.torch', torch_device=torch.cuda.is_available())
#         self.action_lim = 100

  # # class OthelloCNNet(nn.Module):
  # #   def __init__(self, game, args):
  # #     # game params
  # #     self.board_x, self.board_y = game.getBoardSize()
  # #     self.action_size = game.getActionSize()
...
#     self.args = args
#
#     super(OthelloCNNet, self).__init__()
